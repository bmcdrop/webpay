...
def crearTransaccion(users_metadata_id,direccion,comuna_id):
    ...
    payload={buy_order:buy_order,"session_id":session_id,"amount":amount,"return_url":ruta}
...
def verificarTransaccion(token):
    ...
    cabeceros = {'content-type':'aplication/json','Tbk-Api-Key-Id':settings.WEBPAY_ID,'Tbk-Api-Key-Secret':settings.WEBPAY_SECRET}
